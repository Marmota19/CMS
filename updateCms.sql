...
CREATE TABLE IF NOT EXISTS `mcortes`.`technologiesPerProject` (
  ...
  INDEX `fk_technologyPerProject_project1_idx` (`projectId` ASC),
  INDEX `fk_technologyPerProject_technology1_idx` (`technologyId` ASC),
  CONSTRAINT `fk_technologyPerProject_project1`
    FOREIGN KEY (`projectId`)
    REFERENCES `mcortes`.`project` (`projectId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_technologyPerProject_technology1`
